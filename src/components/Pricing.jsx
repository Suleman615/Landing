    ...
    let plans = [
        {
            ...
            features: [
            'העלה 3 קבצים',
            "10 טוקסן עבור שאלות בסיסיות ופונקציונליות צ'אט",
            'נתונים בודדים ללא הגבלה',
            'שירות אישי+עדיפות' 
            ]
        ...
        },
        {
            ...
            price_per_month: 10,
            features: [
            'כל הפונקציונליות הבסיסית',
            'גישה לבוט AI של עורך דין עם בסיס הידע המשפטי של המנהל שלך',
            "20 אסימון עבור שאילתות בסיסיות ופונקציונליות צ'אט",
            'נתונים בודדים ללא הגבלה',
            'שירות אישי+עדיפות'   
            ],
