        ...
        <div className='w-full  bg-[#fbfaf9]'>
            <div dir='rtl' className="  pt-20 pb-0  mx-auto max-w-[1280px]  border-b  border-dashed bg-[#F9FAFB]">
                ...
                <div dir='rtl' className='w-full  text-center sm:text-start  sm:px-10 md:px-2   '>
                    <h5 className="text-[40px] text-center  text-[#585F6E]">איך להשתמש בחמורבי.</h5>
                    <p className=' text-[#757C89] px-2 text-lg text-center'>סרטון לימודי המבהיר כיצד להשתמש בחמורבי על מנת לשפר את ביצועיך כמשפטן ועורך דין.</p>
                </div>
